...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 27 14:15:54 2019
...
#        featureList.append(random.randint(0,100))
    ...
    for aa in inverseTable:
        codonCntList=[]
        for codon in inverseTable[aa]:
            if codon in codonCntDict:
                codonCntList.append(codonCntDict[codon])
            else:
                codonCntList.append(0)
        std=np.std(codonCntList)
        featureList.append(std)
#    print(featureList)
